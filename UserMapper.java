...
import app.mapper.subsription.SubscriptionMapper;
...
public class UserMapper {
    ...
    public static UserDto toUserDto(User user){
        ...
        List<SubscriptionDto> subscriptionDtoList = user.getSubscriptions().stream()
                .map(SubscriptionMapper::toDto)
                .toList();

        List<WalletDto> walletDtoList = user.getWallets().stream()
